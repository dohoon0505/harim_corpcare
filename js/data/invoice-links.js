  ...
  FP9S0QA8YA: {
    ...
    doc: {
      ...
      items: [
        ...
        { date: "2026년 04월 21일", sender: "김태권", address: "경기 성남시 분당구 판교로 289 삼환하이펙스", product: "축하 3단화환 (고급)", amount: "100,000원" },
        { date: "2026년 04월 12일", sender: "박진찬", address: "부산 해운대구 센텀중앙로 79 센텀사이언스파크", product: "근조 3단화환 (기본)", amount: "70,000원" },
      ],
      account: ACCOUNT,
      total: "240,000원",
    },
