...
export const INVOICE_LINKS = {
  ...
  FP9S0QA8YA: {
    ...
    doc: {
      ...
      supplier: SUPPLIER,
      items: [
        { date: "2026년 04월 28일", sender: "홍길동", address: "서울 관악구 관악로 1 서울대학교 행정관", product: "근조 3단화환 (기본)", amount: "75,000원" },
        { date: "2026년 04월 21일", sender: "김태권", address: "경기 성남시 분당구 판교로 289 삼환하이펙스", product: "축하 3단화환 (고급)", amount: "90,000원" },
        { date: "2026년 04월 12일", sender: "박진찬", address: "부산 해운대구 센텀중앙로 79 센텀사이언스파크", product: "근조 3단화환 (기본)", amount: "75,000원" },
      ],
      account: ACCOUNT,
      total: "240,000원",
    },
  ...
  KM3X7BQ2LP: {
    ...
    doc: {
      ...
      supplier: SUPPLIER,
      items: [
        { date: "2026년 03월 30일", sender: "홍길동", address: "서울 강남구 테헤란로 152 강남파이낸스센터", product: "축하 3단화환 (고급)", amount: "90,000원" },
        { date: "2026년 03월 22일", sender: "정소빈", address: "대전 유성구 대학로 99 세종빌딩", product: "특수 화환 (오브제)", amount: "75,000원" },
        { date: "2026년 03월 15일", sender: "임직원", address: "인천 연수구 송도과학로 32 송도컨벤시아", product: "축하 3단화환 (기본)", amount: "75,000원" },
        { date: "2026년 03월 08일", sender: "홍길동", address: "광주 서구 상무중앙로 110 김대중컨벤션센터", product: "근조 3단화환 (기본)", amount: "75,000원" },
      ],
      account: ACCOUNT,
      total: "315,000원",
    },
  ...
  ZT6W1HE4NC: {
    ...
    doc: {
      ...
      supplier: SUPPLIER,
      items: [
        { date: "2026년 04월 26일", sender: "김사원", address: "서울 서초구 서초대로 396 강남빌딩", product: "축하 3단화환 (고급)", amount: "90,000원" },
