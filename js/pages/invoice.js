...
const INVOICE_DATA = {
  ...
  items: [
    { date: "2026년 04월 28일", sender: "홍길동", address: "서울 관악구 신림동 산 56-1 65동 서울대학교 교수회관", product: "근조 3단화환 (기본)", amount: "75,000원" },
    { date: "2026년 04월 25일", sender: "김태권", address: "서울 동산구 아에린로29 신정기념관내 로얄마크컨벤션 3층 포장홀", product: "축하 3단화환 (기본)", amount: "75,000원" },
    { date: "2026년 04월 21일", sender: "김태권", address: "경기 마주시 금품억로 190 새디인병원 장례식장 지하1층 특2호실", product: "근조 3단화환 (기본)", amount: "75,000원" },
    { date: "2026년 04월 17일", sender: "채상운", address: "부산 남구 황령대로 401-9 그랜드드몬트 6층 시그니처룸", product: "축하 3단화환 (고급)", amount: "90,000원" },
    { date: "2026년 04월 14일", sender: "박진찬", address: "경상북도 예천군 예천읍 양오로 154 (정북아) 예천농협장례식장 3호실", product: "근조 3단화환 (기본)", amount: "75,000원" },
    { date: "2026년 04월 10일", sender: "박진찬", address: "서울 강남구 논현로 645 렉시미나호텔", product: "축하 3단화환 (기본)", amount: "75,000원" },
    { date: "2026년 04월 07일", sender: "홍길동", address: "서울 관악구 신림동 산 56-1 65동 서울대학교 교수회관", product: "근조바구니(기본)", amount: "70,000원" },
    { date: "2026년 04월 03일", sender: "김태권", address: "서울 동산구 아에린로29 신정기념관내 로얄마크컨벤션 3층 포장홀", product: "축하 3단화환 (기본)", amount: "75,000원" },
  ],
